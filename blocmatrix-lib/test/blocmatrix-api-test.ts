 ...
 *
 * This test runner allows us to split our tests by BlocmatrixAPI method, and
 ...
 */
describe('BlocmatrixAPI [Test Runner]', function() {
  beforeEach(setupAPI.setup)
  afterEach(setupAPI.teardown)

  // Collect all the tests:
  const allPublicMethods = getAllPublicMethods(new BlocmatrixAPI())
