...
import {decodeAccountID} from 'blocmatrix-address-codec'
import sha512Half from './sha512Half'
import HashPrefix from './hash-prefix'
import {SHAMap, NodeType} from './shamap'
import {encode} from 'blocmatrix-binary-codec'
...
export const computeTrustlineHash = (
  ...
  const prefix = ledgerSpaceHex('blocmatrixState')
  return sha512Half(
...
// see blocmatrixd Ledger::updateHash()
