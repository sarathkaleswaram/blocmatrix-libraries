...
import {Amount, BlocmatrixdAmount} from './amounts'
...
export interface BlocmatrixStateLedgerEntry {
...
// see https://blocmatrix.com/build/ledger-format/#ledger-object-types
