...
import {BlocmatrixdError} from '../common/errors'
...
function convertError(
  ...
  // In the future, we should deprecate this error, instead passing through the one from Blocmatrixd.
