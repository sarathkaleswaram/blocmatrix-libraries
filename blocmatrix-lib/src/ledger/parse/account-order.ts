...
import {parseTimestamp, adjustQualityForBMC} from './utils'
...
// TODO: remove this function once blocmatrixd provides quality directly
...
// blocmatrixd 'account_offers' returns a different format for orders than 'tx'
...
export function parseAccountOrder(
  ...
  const specification = removeUndefined({
    ...
    // blocmatrixd currently does not provide "expiration" in account_offers
