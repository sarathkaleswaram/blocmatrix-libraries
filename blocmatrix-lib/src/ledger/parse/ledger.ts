...
import {removeUndefined, blocmatrixTimeToISO8601} from '../../common'
 ...
 * @throws RangeError: Invalid time value (blocmatrixTimeToISO8601)
 */
    ...
    Object.assign(
      {
        ...
        closeTime: blocmatrixTimeToISO8601(ledger.close_time),
        closeTimeResolution: ledger.close_time_resolution,
        closeFlags: ledger.close_flags,
        ledgerHash: ledger.hash || ledger.ledger_hash,
        ledgerVersion: ledgerVersion,
        parentLedgerHash: ledger.parent_hash,
        parentCloseTime: blocmatrixTimeToISO8601(ledger.parent_close_time),
