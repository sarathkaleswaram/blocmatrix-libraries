...
import {Path, GetPaths, BlocmatrixdPathsResponse} from '../pathfind-types'
...
function parseAlternative(
  ...
  destinationAmount: BlocmatrixdAmount,
  alternative: any
): Path {
...
function parsePathfind(pathfindResult: BlocmatrixdPathsResponse): GetPaths {
