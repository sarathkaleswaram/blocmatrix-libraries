...
const {encodeAccountID} = require('blocmatrix-address-codec')
...
function transactionParsingTests() {
  const transaction = {
    json: {
      'Account': 'baD5qJMAShLeHZXf9wjUmo6vRK4abj9cF3',
      'Fee': '10',
      'Flags': 0,
      'Sequence': 103929,
      'SigningPubKey':
      ...
      'TakerGets': {'currency': 'ILS',
        'issuer': 'bNPRNzBB92BVpAhhZb4iXDTveCgV5Pofm9',
        'value': '1694.768'},
  ...
  it('can be done with high level apis', () => {
    ...
    }
    {
      ...
      assert.equal(value.currency.toJSON(), 'BMC')
    }
    {
      const [field, value] = readField()
...
function pathSetBinaryTests() {
  ...
  // const expectedJSON =
  //   [[{account: 'b9hEDr4xBGRfBCcX3E4FibDWQBAYtpxC8K',
  //     currency: 'BTC',
  //     issuer: 'b9hEDr4xBGRfBCcX3E4FibDWQBAYtpxC8K'},
  //   {account: 'bM1oqKtfh1zgjdAgrFmaRm3rtfGBX25xVo',
  //     currency: 'BTC',
  //     issuer: 'bM1oqKtfh1zgjdAgrFmaRm3rtfGBX25xVo'},
  //   {account: 'bvYAfWj5gh67oV6fW32ZzP3Aw4Eurs59B',
  //     currency: 'BTC',
  ...
  //     currency: 'BTC',
  //     issuer: 'bM1oqKtfh1zgjdAgrFmaRm3rtfGBX25xVo'},
  //   {account: 'bpvfJ4mR6QQAeogpXEKnuyGBx8mYCSnYZi',
  //     currency: 'BTC',
  //     issuer: 'bpvfJ4mR6QQAeogpXEKnuyGBx8mYCSnYZi'},
  //   {currency: 'USD',
  //     issuer: 'bvYAfWj5gh67oV6fW32ZzP3Aw4Eurs59B'}],
  //   [{account: 'b9hEDr4xBGRfBCcX3E4FibDWQBAYtpxC8K',
  //     currency: 'BTC',
  //     issuer: 'b9hEDr4xBGRfBCcX3E4FibDWQBAYtpxC8K'},
  //   {account: 'b3AWrdp2jQLXLywJypdoNwVSvb81xs3uhn',
  //     currency: 'BTC',
  //     issuer: 'b3AWrdp2jQLXLywJypdoNwVSvb81xs3uhn'},
  //   {currency: 'BMC'},
  //   {currency: 'USD',
  //     issuer: 'bvYAfWj5gh67oV6fW32ZzP3Aw4Eurs59B'}]]
