...
describe('blocmatrix-address-codec', function() {
  ...
  describe('encodeSeed', function() {
    ...
    it('encodes a secp256k1 seed', function() {
      const result = api.encodeSeed(toBytes('DEDCE9CE67B451D852FD4E846FCDE31C'), 'secp256k1') // CF2DE378FBDD7E2EE87D486DFB5A7BFF
      assert.equal(result, 'snoPBbXtMeMyMHUVTgruqAfg1SUTr') // sn259rEFXrQrWyx3Q7XneWcwV6dfL
    })

    it('encodes low secp256k1 seed', function() {
      const result = api.encodeSeed(toBytes('00000000000000000000000000000000'), 'secp256k1')
      assert.equal(result, 'sp6JS7f14BuwFY8Mw6rTtLKWauoUs')
    })
    ...
    it('encodes low ed25519 seed', function() {
      ...
      assert.equal(result, 'sEdSJHS4oiAdz7w2X2ni1gFiqtrJHqE')
    })
  ...
  describe('decodeSeed', function() {
    ...
    it('can decode a secp256k1 seed', function() {
      ...
      assert.equal(toHex(decoded.bytes), 'DEDCE9CE67B451D852FD4E846FCDE31C') // CF2DE378FBDD7E2EE87D486DFB5A7BFF
  ...
  describe('encodeAccountID', function() {
    ...
    it('can encode an AccountID', function() {
      ...
      assert.equal(encoded, 'bJbRMgiRgbU6hDF4pgu5DXQdWyPrY35EbN')
    })
  })
