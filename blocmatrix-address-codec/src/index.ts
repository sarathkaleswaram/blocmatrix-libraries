...
export {
  ...
  encodeNodePublic, // Encode bytes to BMC Ledger node public key format
  decodeNodePublic, // Decode an BMC Ledger node public key into its raw bytes
